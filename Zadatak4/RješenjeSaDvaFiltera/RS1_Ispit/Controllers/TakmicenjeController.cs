...
namespace RS1_Ispit_asp.net_core.Controllers
{
    public class TakmicenjeController : Controller
    {
        ...
        public IActionResult Index(int SkolaID =0, int PredmetID=0)
        {
            TakmicenjeIndexVM model;

            if (SkolaID != 0&& PredmetID!=0)
            {
                model = new TakmicenjeIndexVM
                {
                    ...
                    Redovi = db.Takmicenja.Where(x => x.SkolaID == SkolaID&& x.PredmetID == PredmetID).Select(t => new TakmicenjeIndexVM.Red
                    {
                        ...
                        .Where(x => x.TakmicenjeID == t.TakmicenjeID).OrderByDescending(i => i.bodovi)
